...
| [SCALING.md](SCALING.md) | Production scaling and hardening |

The repository [README.md](../README.md) is the high-level entry point and links to **RUNNING.md** for operational steps.
